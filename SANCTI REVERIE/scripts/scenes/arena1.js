export default class Arena1Scene extends Phaser.Scene {
    constructor() {
        super({ key: 'Arena1Scene' });
    ...
    create() {
        //tilemaps
        this.map = this.make.tilemap({key:"arena1", tileWidth:32, tileHeight:32});
